...
def load_data(messages_filepath, categories_filepath):
    ...
    '''
    Loads csv files containing messages and categories
    ...
    Returns:
    dataframe merging both files on id
...
def clean_data(df):
    ...
    Cleans the dataframe to get it ready for machine learning
    
    Parameters:
    df: Dataframe be cleaned
    ...
    # drop duplicates and change value of 2 to mode=1 in 'related' column
...
def save_data(df, database_filename):
    ...
    Paramters:
    df: Dataframe
    database_filename: Name of the sqlite database to be saved to
